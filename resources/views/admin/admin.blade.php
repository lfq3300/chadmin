...
@section('main-header')
    <header class="main-header">
        <a href="{{url('/dashboard')}}" class="logo">
            ...
            <span class="logo-lg"><b>官网后台系统</b></span>
        </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('admin/banner/index')}}"><i class="fa fa-star-o"></i>Banner管理</a></li>
                        <li><a href="{{url('admin/article/index')}}"><i class="fa fa-star-o"></i>文章管理</a></li>
                    </ul>
...
@section('main-footer')
    <footer class="main-footer">
        ...
        {{--<strong>Admin@2017-3-16<a href="https://github.com/LaravelChen" target="_blank">admin</a>.</strong>--}}
    </footer>
@endsection
{{--/底部--}}
